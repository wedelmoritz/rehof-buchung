...
| [0081](0081-endreinigung-freigabe-workflow.md) | Endreinigung als Freigabe-Workflow: `Product.needs_approval` → beim Buchen nur ANGEFRAGT (`ServiceRequest`), BL bestätigt/lehnt im Dashboard ab (Abrechnung + Reinigungsliste erst bei Bestätigung), Status „angefragt/bestätigt/abgelehnt" in „Meine Buchungen" (#28/#33) | Accepted |
